...
IC-9700 支持 1 Hz 频率步进；默认变化超过 10 Hz 才重调（可配置）。
...
```
05:52:19Z EL-025.9° AZ359.6° RR-3.17km/s Δ↓+004604Hz Δ↑-001543Hz Main435.616604 Sub145.991457 [过境]
```

地平线下时显示下一圈 AOS 倒计时，不动电台。
